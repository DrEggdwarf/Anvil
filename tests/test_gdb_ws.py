    ...
    def test_memory(self, gdb_ws_env):
        ...
        with client.websocket_connect(f"/ws/gdb/{sid}") as ws:
            ws.send_json({
                "type": "command",
                "request_id": "mem1",
                "payload": {"command": "memory", "address": "0x7fff0000", "size": 64},
            })
            resp = ws.receive_json()
